...
public class LimitBlocs {
    ...
    public static String getReduced (String str) {
        ...
        if (str.equals("GRANITE")) return "1:1";
        if (str.equals("DIORITE")) return "1:3";
        if (str.equals("ANDESITE")) return "1:5";
        ...
        if (str.equals("BIRCH_LOG")) return "17:2";
        if (str.equals("OAK_LEAVES")) return "18";
        if (str.equals("SPRUCE_LEAVES")) return "18:1";
        if (str.equals("BIRCH_LEAVES")) return "18:2";
        if (str.equals("LAPIS_ORE")) return "21";
        if (str.equals("SANDSTONE")) return "24";
        if (str.equals("GRASS")) return "31:1";
        if (str.equals("FERN")) return "31:2";
        ...
        if (str.equals("DARK_OAK_LEAVES")) return "161:1";
        if (str.equals("DARK_OAK_LOGS")) return "162:1";
        if (str.equals("LARGE_FERN")) return "175:3";
        if (str.equals("ROSE_BUSH")) return "175:4";
    ...
    public static String getDeveloped(String str) {
        ...
        if (str.equals("1:1")) return "GRANITE";
        if (str.equals("1:3")) return "DIORITE";
        if (str.equals("1:5")) return "ANDESITE";
        ...
        if (str.equals("17:2")) return "BIRCH_LOG";
        if (str.equals("18")) return "OAK_LEAVES";
        if (str.equals("18:1")) return "SPRUCE_LEAVES";
        if (str.equals("18:2")) return "BIRCH_LEAVES";
        if (str.equals("21")) return "LAPIS_ORE";
        if (str.equals("24")) return "SANDSTONE";
        if (str.equals("31:1")) return "GRASS";
        if (str.equals("31:2")) return "FERN";
        ...
        if (str.equals("161:1")) return "DARK_OAK_LEAVES";
        if (str.equals("162:1")) return "DARK_OAK_LOGS";
        if (str.equals("175:3")) return "LARGE_FERN";
        if (str.equals("175:4")) return "ROSE_BUSH";
